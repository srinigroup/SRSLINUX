...
public class Application extends Controller {
	...
	public static Result checkHOTTimesheetExistsInEditPageForLeave(Long sId,
			Long empId, String date, String endDate, Long tid, String leaveType) {
		...
		if (newStart.compareTo(lastWednesday) <= 0
			...
			List<Timesheet> timesheetList = Timesheet
					.checkTimesheetExistsInHoEmployeeEditForLeave(sId, empId,
							date, endDate, tid);
	...
	public static Result checkUrl(String filePath){
		...
		return redirect("/INVOICEPROCESSINGSYSTEM/"+filePath);
	}
